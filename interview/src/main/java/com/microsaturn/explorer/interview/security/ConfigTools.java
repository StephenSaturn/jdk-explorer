package com.microsaturn.explorer.interview.security;

import com.microsaturn.explorer.interview.util.Base64;
...
public class ConfigTools {
    ...
    public static void main(String[] args) throws Exception {
        String publicKeyText = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAMU3cGy1I94RbfBF67KIQ2Xd6r4WuUgFXJEj1kgZH7TcGsU0Rjp8BiD7ZBjRznWuby+eVu48wnsdxfCX38uKuosCAwEAAQ==";
        String cipherText = "rscBuyfGT2wZIdcXrsKAhrkMqZ9Mz4WFed49OZMBA+p9rQ4h7Nm1uE129TbArQpYS3uYrdsezA/Q/j9mqKXmUA==";
        System.out.println(decrypt(publicKeyText, cipherText));
    }
