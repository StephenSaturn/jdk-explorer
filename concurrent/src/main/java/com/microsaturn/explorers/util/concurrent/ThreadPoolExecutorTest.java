...
//		System.out.println("task queue size::" + executor.getQueue().size());
	...
	/**
	 * 验证规则2:如果线程数量 > 核心线程数, 但 <= 最大线程数, 并且任务队列是LinkedBlockingDeque的时候, 超过核心线程数量的任务会放在任务队列中排队.
	 * @throws InterruptedException
	 */
	public static void test2() throws InterruptedException {
		// 核心线程数为3个, 最大线程数为6个, 非核心线程超时时间为5s, 任务队列为LinkedBlockingDeque, 因此最大线程数无效, 线程池中的线程数量不会超过3个
	...
	/**
	 * 验证规则3:
	 * 		如果线程数量 > 核心线程数, 但 <= 最大线程数, 并且任务队列是SynchronousQueue的时候, 
	...
	public static void test4() throws InterruptedException {
		...
		// 设置LinkedBlockingDeque大小为2, 则最大线程数量起作用:首先为前三个任务开启了核心线程1, 2, 3 然后第四个任务和第五个任务被加入到队列中, 
		...
		// 设置LinkedBlockingDeque大小为1, 报错:直接出错在第6个execute方法上.因为核心线程数是3个, 当加入第四个任务的时候, 就把第四个放在队列中.
	...
	public static void test5() throws InterruptedException {
		...
		// corePoolSize:3, maximumPoolSize:4,keepAliveTime:5s, workQueue:SynchronousQueue
	...
	public static void test6() throws InterruptedException {
		// corePoolSize:2 maximumPoolSize:3 keepAliveTime:30s workQueue:SynchronousQueue
		ThreadPoolExecutor executor = new ThreadPoolExecutor(2, 3, 30, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(false));
